...
export default function Categories() {
   ...
   return (
      <div className="lg:p-4 p-8 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-items-center gap-2 lg:gap-0">
            ...
            <Link href={`/categories/${category.title}`} key={key + key}>
               <div className="lg:hover:scale-105 hover:cursor-pointer duration-200 lg:w-96 h-auto">
                  <div className="relative items-end">
                     ...
                     <div className="absolute bottom-0 left-0 bg-body-background rounded-bl-3xl rounded-tr-3xl">
