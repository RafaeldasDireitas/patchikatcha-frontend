      ...
      <div className="p-4 lg:p-12 flex flex-col min-h-screen">
         ...
         <Accordion type="single" collapsible className="w-full p-4">
            ...
            <AccordionItem value="item-2">
               <AccordionTrigger className="quicksand-semibold">Why are your delivery times longer than other shops?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-3">
               <AccordionTrigger className="quicksand-semibold">What does PatchiKatcha mean?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-4">
               <AccordionTrigger className="quicksand-semibold">How can I sign up for your Newsletter?</AccordionTrigger>
               <AccordionContent>You can sign up for free in our homepage.</AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-5">
               <AccordionTrigger className="quicksand-semibold">Why should I subscribe to your Newsletter?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-6">
               <AccordionTrigger className="quicksand-semibold">Why are there only a few designs so far?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-7">
               <AccordionTrigger className="quicksand-semibold">Does PatchiKatcha have a physical store?</AccordionTrigger>
               <AccordionContent>We currently do not have a physical store.</AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-8">
               <AccordionTrigger className="quicksand-semibold">Will I have to pay any import fees?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-9">
               <AccordionTrigger className="quicksand-semibold">Where can I track my order?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-10">
               <AccordionTrigger className="quicksand-semibold">How can I issue a refund?</AccordionTrigger>
               <AccordionContent>
            ...
            <AccordionItem value="item-11">
               <AccordionTrigger className="quicksand-semibold">I haven't received any confirmation email for my order.</AccordionTrigger>
               <AccordionContent>
